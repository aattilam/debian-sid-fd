...
apt install gnome-core libreoffice libreoffice-gnome gnome-tweaks firefox-esr flatpak gnome-software-plugin-flatpak git nala vlc qgnomeplatform-qt5 adwaita-qt adwaita-qt6 firmware-misc-nonfree -y
